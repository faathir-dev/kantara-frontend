...
function LoginContainer() {
  ...
  return (
    <div className="flex flex-col md:grid md:grid-cols-2 h-screen">
      {/* Sisi Kiri: Background Gambar Sekolah */}
      <div 
        className="relative hidden md:flex flex-col w-full h-screen items-center justify-center gap-8 p-8"
        style={{
          backgroundImage: `url('https://lh3.googleusercontent.com/gps-cs-s/AHRPTWlCjQ-a4YD62vm2ZQ5pqCQZyZuO6ZhYE5vbZAflswB81fpujPDxVXf0MDtAdVGIcPDX4ReJ-icvee7Z889MuPl4I-bNcBuD4bPjP03tP6WygTi141rPXmFtOl6_FabKmCmQ_Y0pdw=s680-w680-h510-rw')`,
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          backgroundRepeat: 'no-repeat',
        }}
      >
        {/* Lapisan Hitam Transparan (Overlay) agar teks kontras dan terbaca */}
        <div className="absolute inset-0 bg-black/40"></div>

        {/* Teks Selamat Datang */}
        <p className="text-white text-3xl font-bold text-center z-10 relative">
          Selamat Datang di Kantara
        </p>
      </div>
